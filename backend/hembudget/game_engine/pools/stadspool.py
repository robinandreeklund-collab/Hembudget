...
STADSPOOL: list[Stad] = [
    ...
    Stad(
        ...
        avg_brf_price_per_kvm=78_000,
        avg_villa_price_per_kvm=62_000,
    ...
    Stad(
        ...
        avg_brf_price_per_kvm=52_000,
        avg_villa_price_per_kvm=48_000,
    ...
    Stad(
        ...
        avg_brf_price_per_kvm=38_000,
        avg_villa_price_per_kvm=42_000,
    ...
    Stad(
        ...
        avg_brf_price_per_kvm=50_000,
        avg_villa_price_per_kvm=45_000,
    ...
    Stad(
        ...
        bostad_pct_hyresratt=0.50,
        avg_brf_price_per_kvm=37_000,
        avg_villa_price_per_kvm=35_000,
    ...
    Stad(
        ...
        avg_villa_price_per_kvm=29_000,
        avg_rental_per_kvm_month=115,
        weight=0.7,
    ),
    Stad(
        ...
        avg_villa_price_per_kvm=26_000,
    ...
    Stad(
        ...
        avg_villa_price_per_kvm=22_000,
    ...
    Stad(
        ...
        bostad_pct_villa=0.30,
        bostad_pct_hyresratt=0.50,
        avg_brf_price_per_kvm=24_000,
        avg_villa_price_per_kvm=21_000,
        avg_rental_per_kvm_month=105,
        weight=0.4,
    ),
    Stad(
    ...
    Stad(
        ...
        bostad_pct_hyresratt=0.45,
        avg_brf_price_per_kvm=22_000,
        avg_villa_price_per_kvm=18_000,
    ...
    Stad(
        ...
        avg_brf_price_per_kvm=15_000,
        avg_villa_price_per_kvm=13_000,
