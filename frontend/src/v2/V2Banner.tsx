  ...
  return (
    ...
    >
      ...
      <span style={{ marginLeft: "auto", display: "flex", gap: 12, alignItems: "center", flexWrap: "wrap" }}>
        ...
        <Link to="/v2/banken" style={{ color: "#0f172a", textDecoration: "none" }}>
          v2/banken
        </Link>
        <Link to="/v2/budget" style={{ color: "#0f172a", textDecoration: "none" }}>
          v2/budget
        </Link>
        <Link
          to="/v2/arbetsgivaren"
        ...
        <Link to="/v2/skatten" style={{ color: "#0f172a", textDecoration: "none" }}>
          v2/skatten
        </Link>
        <Link to="/v2/lan" style={{ color: "#0f172a", textDecoration: "none" }}>
          v2/lan
        </Link>
