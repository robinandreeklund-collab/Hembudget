 ...
 *
 * Pedagogisk migrations-indikator: visar att man är i v2 + länkar
 * tillbaka till v1. För super-admin är detta hjälp att navigera
 * mellan gamla och nya gränssnittet under utvecklingen.
 */
    ...
    >
      ...
      {status.is_super_admin && (
        <span style={{ background: "#0f172a", color: "#fbbf24", padding: "2px 8px", borderRadius: 100, fontWeight: 700 }}>
          SUPER-ADMIN · auto-routad till v2
        </span>
      )}
      <span style={{ color: "#64748b" }}>· {status.role}</span>
      <span style={{ marginLeft: "auto", display: "flex", gap: 12 }}>
        <Link to="/dashboard" style={{ color: "#dc4c2b", textDecoration: "none", fontWeight: 700 }}>
          ← Gamla gränssnittet (v1)
        </Link>
