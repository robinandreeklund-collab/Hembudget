...
// ---------- Aktie-emotion: loss aversion + hindsight ----------

function StockEmotion() {
  return (
    <section id="aktier" className="border-t border-rule bg-white">
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-14 md:py-20">
        <div className="section-divider mb-10">
          Aktiehandel — som du faktiskt känner den
        </div>
        <div className="max-w-3xl mb-12">
          <h2 className="serif text-4xl md:text-5xl leading-[1.05]">
            Förluster gör 2× så ont som vinster glädjer.
          </h2>
          <p className="mt-5 lead">
            Vi har inte byggt en kursras-simulator — vi har byggt en
            spegel. Wellbeing-Trygghet räknar in portföljens 24h-rörelse
            med λ ≈ 2,0 (Kahneman/Tversky). Om eleven inte känner
            smärtan av en förlust på sin egen mätare har hen aldrig
            övat psykologin.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-5">
          ...
          <div className="border-[1.5px] border-ink bg-paper p-5">
            <div className="text-[10px] uppercase tracking-wider text-rose-700 mb-2">
              Realtidsmätare · förlust
            </div>
            <div className="flex items-baseline gap-3 mb-3">
              <span className="serif text-4xl font-semibold text-rose-700">
                −4 p
              </span>
            ...
            <p className="body-prose text-sm">
              ...
              kostade dig <strong>4 Trygghet-poäng</strong> — dubbelt så
              mycket som en lika stor vinst hade gett. Det är loss
              aversion i en mätare.
            </p>
          </div>
          ...
          <div className="border-[1.5px] border-ink bg-paper p-5">
            ...
            <div className="flex items-baseline gap-3 mb-3">
              <span className="serif text-4xl font-semibold text-emerald-700">
                +2 p
              </span>
              <span className="text-sm text-slate-600">
                Trygghet · 24 h
            ...
            <p className="body-prose text-sm">
              ...
              <strong>2 poäng</strong>. En lika stor förlust hade
              kostat 4 — det är loss aversion i en mätare. Eleven
              tränar att se den asymmetrin.
            </p>
          </div>
        </div>

        {/* Aktie-eftertanke */}
        <div className="mt-10 grid md:grid-cols-[1.3fr_1fr] gap-8 items-start">
          <div className="border-[1.5px] border-ink bg-paper p-6">
            ...
            <h3 className="serif text-2xl leading-snug mb-4">
              Du säljer 1,8× oftare i förlust än i vinst.
            </h3>
            <ul className="space-y-3 text-sm body-prose">
              <li className="flex items-start gap-2">
                <span className="text-emerald-700 font-semibold flex-shrink-0">
                  ✓
                </span>
                <span>
              ...
              <li className="flex items-start gap-2">
                <span className="text-rose-700 font-semibold flex-shrink-0">
                  ⚠
                </span>
                <span>
            ...
            <p className="mt-4 text-xs text-slate-600 italic">
              Ingen facit. Bara en spegel som visar mönstren — så att
          ...
          <div>
            <h3 className="serif text-2xl leading-snug mb-3">
              Disposition effect i din portfölj.
            </h3>
            <p className="body-prose text-sm mb-3">
              Klassiskt nybörjarmönster: sälj vinnare för tidigt, behåll
              förlorare för länge. Kvoten <strong>säljer i förlust ÷
              säljer i vinst</strong> visar vart du är på resan.
            </p>
            <ul className="space-y-1 text-sm body-prose">
              <li>
                <strong>1,0</strong> — balanserat
              </li>
              <li>
                <strong>1,5–2,0</strong> — typisk nybörjare
              </li>
              <li>
                <strong>≥ 2,5</strong> — mönster värt att bryta
              </li>
            </ul>
